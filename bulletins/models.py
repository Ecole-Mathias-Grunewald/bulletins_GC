...
class Classe(models.Model):
    ...
    descriptif = models.TextField(blank=True, default='')
...
class SeuilsCompteurCaracteres(models.Model):
    ...
    discipline_commentaire_limit = models.PositiveIntegerField(default=1000, verbose_name='Limite stricte', help_text='0 = pas de limite')
    ...
    discipline_descriptif_limit = models.PositiveIntegerField(default=1000, verbose_name='Limite stricte', help_text='0 = pas de limite')
    ...
    stage_descriptif_limit = models.PositiveIntegerField(default=1000, verbose_name='Limite stricte', help_text='0 = pas de limite')
    ...
    stage_appreciation_limit = models.PositiveIntegerField(default=1000, verbose_name='Limite stricte', help_text='0 = pas de limite')
    ...
    projet_descriptif_limit = models.PositiveIntegerField(default=1000, verbose_name='Limite stricte', help_text='0 = pas de limite')
    ...
    projet_appreciation_limit = models.PositiveIntegerField(default=1000, verbose_name='Limite stricte', help_text='0 = pas de limite')
    ...
    avis_college_limit = models.PositiveIntegerField(default=1000, verbose_name='Limite stricte', help_text='0 = pas de limite')
