...
class SeuilsCompteurCaracteresForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'discipline_commentaire_limit': forms.NumberInput(attrs={'class': 'form-control', 'min': 0}),
            ...
            'discipline_descriptif_limit': forms.NumberInput(attrs={'class': 'form-control', 'min': 0}),
            ...
            'stage_descriptif_limit': forms.NumberInput(attrs={'class': 'form-control', 'min': 0}),
            ...
            'stage_appreciation_limit': forms.NumberInput(attrs={'class': 'form-control', 'min': 0}),
            ...
            'projet_descriptif_limit': forms.NumberInput(attrs={'class': 'form-control', 'min': 0}),
            ...
            'projet_appreciation_limit': forms.NumberInput(attrs={'class': 'form-control', 'min': 0}),
            ...
            'avis_college_limit': forms.NumberInput(attrs={'class': 'form-control', 'min': 0}),
        }